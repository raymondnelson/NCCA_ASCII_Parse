...
applyFilter <- function(x=uniqueExams, 
  ...
  # source('~/R/NCCA_ASCII_Parse/lowPass.2.R', echo=FALSE)
  # source('~/R/NCCA_ASCII_Parse/highPass.03.R', echo=FALSE)

  # source the script for some helper functions minPeak, MASmooth, maxPeak, interpolatePeaks
  # source('~/R/NCCA_ASCII_Parse/EDASigProcHelper.R', echo=FALSE)
  # source('~/R/NCCA_ASCII_Parse/tsVar.R', echo=TRUE)
