...
getOSS2ScoresFn <- function(x=examName, 
  ...
  # R Script to make a table of Probability Analysis  scores for an exam in the cwd
  # Feb 6, 2019
  # Raymond Nelson
  #
  ###############
  ...
  # y can be a vector of multiple series within an exam
  # 
  # no visible output
  ...
  for (i in 1:length(uniqueSeries)) {
    ...
    for (j in 1:length(uniqueCharts)) {
      ...
      # iterate over the RQs to get the scores question subtotals for this chart
      k=1
