...
PAScoresFn <- function(RqCqDFSeries=RqCqDFSeries, 
  ...
  PAOutputList <- list(ProbabilityAnalysis="Probability Analysis (Kircher & Raskin, 1988; Raskin, Kircher, Honts & Horowitz, 1988)",
                       ...
                       MLETruthfulRQs=pTruthful,
                       MLEDeceptiveRQs=pDeceptive,
                       PAPostProbRQSubTotT=postTruthfulRQs,
                       PAPostProbRQSubTotD=postDeceptiveRQs,
                       PADiscriminateScoreSubTotals=discriminateScoreRQs,
                       PACoefs=PACoefs,
                       PAPrior=PAPrior ,
