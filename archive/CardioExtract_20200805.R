...
CardioExtractFn <- function(x=segmentDF, 
  ...
  #### reset the cardioExtract and measurement columns ####
  ...
  
  {
    ...
    # segmentDF$CardioMeasure[stimOnsetRow:nrow(segmentDF)] <- ""
    # segmentDF$CardioDuration[stimOnsetRow:nrow(segmentDF)] <- ""
    # segmentDF$CardioComplexity[stimOnsetRow:nrow(segmentDF)] <- ""
    
    segmentDF$CardioMeasure_d[stimOnsetRow:nrow(segmentDF)] <- ""
    segmentDF$CardioDuration_d[stimOnsetRow:nrow(segmentDF)] <- ""
    segmentDF$CardioComplexity_d[stimOnsetRow:nrow(segmentDF)] <- ""
    
    segmentDF$CardioMeasure_s[stimOnsetRow:nrow(segmentDF)] <- ""
    segmentDF$CardioDuration_s[stimOnsetRow:nrow(segmentDF)] <- ""
    segmentDF$CardioComplexity_s[stimOnsetRow:nrow(segmentDF)] <- ""
    
    segmentDF$CardioMeasure_m[stimOnsetRow:nrow(segmentDF)] <- ""
    segmentDF$CardioDuration_m[stimOnsetRow:nrow(segmentDF)] <- ""
    segmentDF$CardioComplexity_m[stimOnsetRow:nrow(segmentDF)] <- ""
    
    segmentDF$CardioMeasure_v[stimOnsetRow:nrow(segmentDF)] <- ""
    segmentDF$CardioDuration_v[stimOnsetRow:nrow(segmentDF)] <- ""
    segmentDF$CardioComplexity_v[stimOnsetRow:nrow(segmentDF)] <- ""
  ...
  if(cardioRate >= 40 && cardioRate <= 110) {
    ...
    segmentDF$CardioMeasure <- ""
    segmentDF$CardioDuration <- ""
    segmentDF$CardioComplexity <- ""
