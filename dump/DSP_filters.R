...
applyFilter <- function(x=uniqueExams, 
  ...
  source('~/dropbox/R_programming/NCCA_ASCII_Parse/lowPass.2.R', echo=FALSE)
  source('~/dropbox/R_programming/NCCA_ASCII_Parse/highPass.03.R', echo=FALSE)
  ...
  # source('~/dropbox/R_programming/NCCA_ASCII_Parse/tsVar.R', echo=TRUE)
